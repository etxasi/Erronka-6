    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Reset siempre desactivado  \n(No suele usarse)",
            "readonly": true
          },
          "position": {
            "x": 144,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 1: Contanr las pulsaciones de un boton\n\nEl contador cuenta las veces que presionamos el pulsador(D13) y muestra la cuenta en binario usando 2 led.\nEste contador es de dos bits, por tanto solo cuenta hasta 4 y cuando se da ese caso se resetea a 0.\n",
            "readonly": true
          },
          "position": {
            "x": 256,
