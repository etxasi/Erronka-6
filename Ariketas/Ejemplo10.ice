    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 10: Escaner de supermercado. Contando los articulos comprados\n\nContaddor de objetos que se pasan por el \"sensor de IR\". Al detectar un objeto emite un pitido y luego incrementa el contador, que se muestra en un display de 7 segmentos de 3 bits (por lo que solo cuenta de 0 a 7)",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        {
          "id": "dc0c22bb-74c8-4ecf-8989-4f0a51e4920f",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "dc0c22bb-74c8-4ecf-8989-4f0a51e4920f",
