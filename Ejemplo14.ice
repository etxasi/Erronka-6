    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 14: Secuencia de leds\n\nSe reproduce en los leds la secuencia de movimiento de KITT, de la serie de los 80s titulada el coche fantastico (knight rider). Consiste en encender un led cada vez, dando la sensación de que hay una unica luz que se mueve horizontalmente, de lado a lado",
            "readonly": true
          },
          "position": {
            "x": 136,
